# Substrate Runtime Toolbox: srtool v0.9.22
...
-   `paritytech/srtool:1.64.0-0.9.22`

-   `paritytech/srtool:1.64.0`

The tags not mentioning the build version always point to the latest one. In the example above, `paritytech/srtool:1.64.0` is the same image than `paritytech/srtool:1.64.0-0.9.22`.
