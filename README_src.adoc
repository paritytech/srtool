...
The project was initially developed from https://gitlab.com/chevdor.
...
IMPORTANT: This method is legacy and deprecated. It is recommended to use the `srtool-cli` utility mentioned above. This information is left here however for documentation purposes -- all the functions are now availabe in the `srtool-cli`.
